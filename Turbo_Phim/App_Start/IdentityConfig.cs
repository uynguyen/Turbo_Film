...
namespace Turbo_Phim.Models
{
    ...
    public class SignInHelper
    {
        ...
        public async Task<Turbo_Phim.Models.SignInStatus> TwoFactorSignIn(string provider, string code, bool isPersistent, bool rememberBrowser)
        {
            var userId = await GetVerifiedUserIdAsync();
            if (userId == null)
            {
                return Turbo_Phim.Models.SignInStatus.Failure;
            }
            ...
            {
                return Turbo_Phim.Models.SignInStatus.LockedOut;
            }
            if (await UserManager.VerifyTwoFactorTokenAsync(user.Id, provider, code))
            {
                ...
                return Turbo_Phim.Models.SignInStatus.Success;
            }
        ...
        public async Task<Turbo_Phim.Models.SignInStatus> ExternalSignIn(ExternalLoginInfo loginInfo, bool isPersistent)
        {
        ...
        private async Task<Turbo_Phim.Models.SignInStatus> SignInOrTwoFactor(ApplicationUser user, bool isPersistent)
        {
                ...
                !await AuthenticationManager.TwoFactorBrowserRememberedAsync(user.Id))
            {
                ...
                return Turbo_Phim.Models.SignInStatus.RequiresTwoFactorAuthentication;
            }
        ...
        public async Task<Turbo_Phim.Models.SignInStatus> PasswordSignIn(string userName, string password, bool isPersistent, bool shouldLockout)
        {
